...
#  string(REPLACE "." "\\" PROTOBUF_SOURCE_WIN32_PATH ${CMAKE_BINARY_DIR})
#  string(REPLACE "." "\\" PROTOBUF_BINARY_WIN32_PATH ${CMAKE_BINARY_DIR})
  string(REPLACE "cmake" ","  protobuf_RC_FILEVERSION "${protobuf_VERSION}")
...
get_filename_component(protobuf_source_dir "." ABSOLUTE)
