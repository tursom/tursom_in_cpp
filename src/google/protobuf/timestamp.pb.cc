...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2ftimestamp_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2ftimestamp_2eproto(
...
#undef CHK_
        ...
        ::PROTOBUF_NAMESPACE_ID::uint8 *Timestamp::_InternalSerialize(
            ...
            if (this->seconds() != 0) {
                ...
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(1,
...
PROTOBUF_NAMESPACE_OPEN
        template<>
        PROTOBUF_NOINLINE PROTOBUF_NAMESPACE_ID::Timestamp *
