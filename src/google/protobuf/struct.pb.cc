...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2fstruct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2fstruct_2eproto(
            ...
            if (!this->_internal_fields().empty()) {
                ...
                if (stream->IsSerializationDeterministic() &&
                    ...
                    for (size_type i = 0; i < n; i++) {
                        target = Struct_FieldsEntry_DoNotUse::Funcs::InternalSerialize(1,
                    ...
                    for (::PROTOBUF_NAMESPACE_ID::Map<std::string, PROTOBUF_NAMESPACE_ID::Value>::const_iterator
                        ...
                        target = Struct_FieldsEntry_DoNotUse::Funcs::InternalSerialize(1, it->first, it->second, target,
                                                                                       stream);
                        Utf8Check::Check(&(*it));
                    }
                }
...
// ===================================================================
        ...
        void Value::set_allocated_struct_value(PROTOBUF_NAMESPACE_ID::Struct *struct_value) {
            ...
            if (struct_value) {
                ::PROTOBUF_NAMESPACE_ID::Arena *submessage_arena =
                        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<PROTOBUF_NAMESPACE_ID::Struct>::GetOwningArena(
                                struct_value);
        ...
        void Value::set_allocated_list_value(PROTOBUF_NAMESPACE_ID::ListValue *list_value) {
            ...
            if (list_value) {
                ::PROTOBUF_NAMESPACE_ID::Arena *submessage_arena =
                        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<PROTOBUF_NAMESPACE_ID::ListValue>::GetOwningArena(
                                list_value);
                if (message_arena != submessage_arena) {
...
#undef CHK_
        ...
        ::PROTOBUF_NAMESPACE_ID::uint8 *Value::_InternalSerialize(
            ...
            if (_internal_has_number_value()) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(2,
                                                                                               this->_internal_number_value(),
                                                                                               target);
            }
            ...
            if (_internal_has_bool_value()) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(4,
