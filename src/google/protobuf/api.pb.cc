...
PROTOBUF_NAMESPACE_OPEN
        constexpr Api::Api(
                ...
                : methods_(), options_(), mixins_(),
                  name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string),
                  version_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string), source_context_(nullptr),
                  syntax_(0) {}
        ...
        constexpr Method::Method(
                ...
                : options_(), name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string),
                  ...
                  request_streaming_(false), response_streaming_(false), syntax_(0) {}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2fapi_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2fapi_2eproto(
        ...
        Method::Method(const Method &from)
            ...
            if (!from._internal_request_type_url().empty()) {
                request_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                      from._internal_request_type_url(),
                                      GetArenaForAllocation());
            }
            ...
            if (!from._internal_response_type_url().empty()) {
                response_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                       from._internal_response_type_url(),
                                       GetArenaForAllocation());
            }
        ...
        ::PROTOBUF_NAMESPACE_ID::uint8 *Method::_InternalSerialize(
            ...
            if (this->request_streaming() != 0) {
                ...
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(3,
                                                                                             this->_internal_request_streaming(),
                                                                                             target);
            }
            ...
            if (this->response_streaming() != 0) {
                ...
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5,
                                                                                             this->_internal_response_streaming(),
                                                                                             target);
            }
