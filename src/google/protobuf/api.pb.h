...
// string version = 4;
        ...
        void Api::set_version(ArgT0 &&arg0, ArgT... args) {
            ...
            version_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0),
                         args..., GetArenaForAllocation());
        ...
        inline void Api::_internal_set_version(const std::string &value) {
            ...
            version_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                         GetArenaForAllocation());
        }
...
// string request_type_url = 2;
        ...
        void Method::set_request_type_url(ArgT0 &&arg0, ArgT... args) {
            ...
            request_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
        ...
        inline void Method::_internal_set_request_type_url(const std::string &value) {
            ...
            request_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                                  GetArenaForAllocation());
        }

        inline std::string *Method::_internal_mutable_request_type_url() {

            return request_type_url_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                             GetArenaForAllocation());
        }

        inline std::string *Method::release_request_type_url() {
            // @@protoc_insertion_point(field_release:google.protobuf.Method.request_type_url)
            return request_type_url_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                             GetArenaForAllocation());
        }
        ...
        inline void Method::set_allocated_request_type_url(std::string *request_type_url) {
            ...
            request_type_url_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                           request_type_url,
                                           GetArenaForAllocation());
...
// string response_type_url = 4;
        ...
        void Method::set_response_type_url(ArgT0 &&arg0, ArgT... args) {
            ...
            response_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                   static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
        ...
        inline void Method::_internal_set_response_type_url(const std::string &value) {
            ...
            response_type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                                   GetArenaForAllocation());
        }

        inline std::string *Method::_internal_mutable_response_type_url() {

            return response_type_url_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                              GetArenaForAllocation());
        }
...
// string root = 2;
        ...
        void Mixin::set_root(ArgT0 &&arg0, ArgT... args) {
            ...
            root_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0),
                      args..., GetArenaForAllocation());
        ...
        inline void Mixin::_internal_set_root(const std::string &value) {
            ...
            root_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                      GetArenaForAllocation());
        }

        inline std::string *Mixin::_internal_mutable_root() {

            return root_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                 GetArenaForAllocation());
        }

        inline std::string *Mixin::release_root() {
            // @@protoc_insertion_point(field_release:google.protobuf.Mixin.root)
            return root_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                 GetArenaForAllocation());
        }
