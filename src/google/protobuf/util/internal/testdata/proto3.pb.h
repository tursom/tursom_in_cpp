...
PROTOBUF_NAMESPACE_OPEN
        template<>
        ::proto_util_converter::testing::Proto3Message *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::Proto3Message>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace proto_util_converter {
    namespace testing {
...
// .proto_util_converter.testing.Proto3Message.NestedEnum enum_value = 1;
        ...
        inline void
        Proto3Message::_internal_set_enum_value(::proto_util_converter::testing::Proto3Message_NestedEnum value) {
...
PROTOBUF_NAMESPACE_OPEN
        ...
        template<>
        struct is_proto_enum<::proto_util_converter::testing::Proto3Message_NestedEnum> : ::std::true_type {
        };
