...
namespace proto_util_converter {
    namespace testing {
        constexpr DefaultValueTest::DefaultValueTest(
                ...
                : repeated_double_(), string_value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string),
                  bytes_value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string), double_value_(0),
                  int64_value_(int64_t{0}), float_value_(0), int32_value_(0), uint64_value_(uint64_t{0u}),
                  uint32_value_(0u), bool_value_(false), enum_value_(0) {}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto = {
        ...
        &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto_once, nullptr,
        0, 1,
        schemas, file_default_instances,
        TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto::offsets,
...
descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto_getter() {
    return &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto(
        &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_5ftest_2eproto);
namespace proto_util_converter {
    namespace testing {
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.DefaultValueTest)
        ...
        const char *
        DefaultValueTest::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
                ...
                switch (tag >> 3) {
                    ...
                    case 18:
                        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 144)) {
                            ...
                            CHK_(ptr);
                            _internal_set_enum_value(
                                    static_cast<::proto_util_converter::testing::DefaultValueTest_EnumDefault>(val));
                        } else goto handle_unusual;
                        continue;
                    default: {
                        handle_unusual:
...
#undef CHK_
        ...
        ::PROTOBUF_NAMESPACE_ID::uint8 *DefaultValueTest::_InternalSerialize(
            ...
            if (!(this->float_value() <= 0 && this->float_value() >= 0)) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(3,
            ...
            if (this->uint64_value() != 0) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt64ToArray(7,
            ...
            if (this->uint32_value() != 0) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(11,
            ...
            if (this->bool_value() != 0) {
                target = stream->EnsureSpace(target);
                target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(13,
...
PROTOBUF_NAMESPACE_OPEN
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::DefaultValueTest *
