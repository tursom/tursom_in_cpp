...
PROTOBUF_NAMESPACE_OPEN
        template<>
        ::proto_util_converter::testing::oneofs::Data *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::oneofs::Data>(Arena *);

        template<>
        ::proto_util_converter::testing::oneofs::MoreData *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::oneofs::MoreData>(Arena *);

        template<>
        ::proto_util_converter::testing::oneofs::OneOfsRequest *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::oneofs::OneOfsRequest>(Arena *);

        template<>
        ::proto_util_converter::testing::oneofs::RequestWithSimpleOneof *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::oneofs::RequestWithSimpleOneof>(Arena *);

        template<>
        ::proto_util_converter::testing::oneofs::Response *
        Arena::CreateMaybeMessage<::proto_util_converter::testing::oneofs::Response>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace proto_util_converter {
    namespace testing {
        namespace oneofs {
...
// string str_data = 2;
            ...
            inline void OneOfsRequest::_internal_set_str_data(const std::string &value) {
                ...
                data_.str_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                                    GetArenaForAllocation());
            }
            ...
            inline std::string *OneOfsRequest::release_str_data() {
                ...
                if (_internal_has_str_data()) {
                    clear_has_data();
                    return data_.str_data_.ReleaseNonDefault(
...
// .proto_util_converter.testing.oneofs.Data message_data = 4;
            ...
            inline void OneOfsRequest::unsafe_arena_set_allocated_message_data(
                    ::proto_util_converter::testing::oneofs::Data *message_data) {
                clear_data();
                if (message_data) {
...
// .proto_util_converter.testing.oneofs.MoreData more_data = 5;
            ...
            inline void OneOfsRequest::unsafe_arena_set_allocated_more_data(
                    ::proto_util_converter::testing::oneofs::MoreData *more_data) {
                clear_data();
                if (more_data) {
                    set_has_more_data();
...
// .google.protobuf.Struct struct_data = 6;
            ...
            inline void
            OneOfsRequest::unsafe_arena_set_allocated_struct_data(PROTOBUF_NAMESPACE_ID::Struct *struct_data) {
                clear_data();
                if (struct_data) {
                    set_has_struct_data();
...
// .google.protobuf.ListValue list_value_data = 8;
            ...
            inline void OneOfsRequest::unsafe_arena_set_allocated_list_value_data(
                    PROTOBUF_NAMESPACE_ID::ListValue *list_value_data) {
                clear_data();
                if (list_value_data) {
...
// .proto_util_converter.testing.oneofs.Data message_data = 4;
            ...
            inline const ::proto_util_converter::testing::oneofs::Data &
            RequestWithSimpleOneof::_internal_message_data() const {
                return _internal_has_message_data()
                       ? *data_.message_data_
                       : reinterpret_cast< ::proto_util_converter::testing::oneofs::Data &>(::proto_util_converter::testing::oneofs::_Data_default_instance_);
            }
            ...
            inline ::proto_util_converter::testing::oneofs::Data *
            RequestWithSimpleOneof::unsafe_arena_release_message_data() {
            ...
            inline void RequestWithSimpleOneof::unsafe_arena_set_allocated_message_data(
                    ::proto_util_converter::testing::oneofs::Data *message_data) {
                clear_data();
                if (message_data) {
                    set_has_message_data();
            ...
            inline ::proto_util_converter::testing::oneofs::Data *
            RequestWithSimpleOneof::_internal_mutable_message_data() {
                if (!_internal_has_message_data()) {
                    clear_data();
                    set_has_message_data();
                    data_.message_data_ = CreateMaybeMessage<::proto_util_converter::testing::oneofs::Data>(
...
// .proto_util_converter.testing.oneofs.MoreData more_data = 5;
            ...
            inline const ::proto_util_converter::testing::oneofs::MoreData &
            RequestWithSimpleOneof::_internal_more_data() const {
                return _internal_has_more_data()
                       ? *data_.more_data_
                       : reinterpret_cast< ::proto_util_converter::testing::oneofs::MoreData &>(::proto_util_converter::testing::oneofs::_MoreData_default_instance_);
            }
            ...
            inline ::proto_util_converter::testing::oneofs::MoreData *
            RequestWithSimpleOneof::unsafe_arena_release_more_data() {
            ...
            inline void RequestWithSimpleOneof::unsafe_arena_set_allocated_more_data(
                    ::proto_util_converter::testing::oneofs::MoreData *more_data) {
                clear_data();
                if (more_data) {
                    set_has_more_data();
            ...
            inline ::proto_util_converter::testing::oneofs::MoreData *
            RequestWithSimpleOneof::_internal_mutable_more_data() {
                if (!_internal_has_more_data()) {
                    clear_data();
                    set_has_more_data();
                    data_.more_data_ = CreateMaybeMessage<::proto_util_converter::testing::oneofs::MoreData>(
...
// string str_value = 1;
            ...
            inline void MoreData::_internal_set_str_value(const std::string &value) {
                ...
                str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
                               GetArenaForAllocation());
            }

            inline std::string *MoreData::_internal_mutable_str_value() {

                return str_value_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                          GetArenaForAllocation());
            }
            ...
            inline std::string *MoreData::release_str_value() {
                ...
                return str_value_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
                                          GetArenaForAllocation());
            }
