    ...
    namespace testing {
        namespace oneofs {
            constexpr OneOfsRequest::OneOfsRequest(
                    ...
                    : value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string), any_data_(nullptr),
                      _oneof_case_{} {}
            ...
            constexpr RequestWithSimpleOneof::RequestWithSimpleOneof(
                    ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
                    : value_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string), _oneof_case_{} {}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto = {
        ...
        &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_once,
        descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_deps, 3, 5,
        schemas, file_default_instances,
        TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto::offsets,
        file_level_metadata_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto,
        file_level_enum_descriptors_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto,
...
descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_getter() {
    return &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto(
        &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto);
namespace proto_util_converter {
    namespace testing {
        namespace oneofs {
...
// ===================================================================
            ...
            void
            OneOfsRequest::set_allocated_message_data(::proto_util_converter::testing::oneofs::Data *message_data) {
                ::PROTOBUF_NAMESPACE_ID::Arena *message_arena = GetArenaForAllocation();
                clear_data();
                if (message_data) {
                    ::PROTOBUF_NAMESPACE_ID::Arena *submessage_arena =
                            ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::proto_util_converter::testing::oneofs::Data>::GetOwningArena(
                                    message_data);
            ...
            void OneOfsRequest::set_allocated_more_data(::proto_util_converter::testing::oneofs::MoreData *more_data) {
                ...
                if (more_data) {
                    ::PROTOBUF_NAMESPACE_ID::Arena *submessage_arena =
                            ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::proto_util_converter::testing::oneofs::MoreData>::GetOwningArena(
                                    more_data);
                    if (message_arena != submessage_arena) {
            ...
            OneOfsRequest::OneOfsRequest(const OneOfsRequest &from)
                ...
                if (!from._internal_value().empty()) {
                    value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                ...
                switch (from.data_case()) {
                    ...
                    case kMessageData: {
                        _internal_mutable_message_data()->::proto_util_converter::testing::oneofs::Data::MergeFrom(
                                from._internal_message_data());
                        break;
                    }
                    case kMoreData: {
                        _internal_mutable_more_data()->::proto_util_converter::testing::oneofs::MoreData::MergeFrom(
                                from._internal_more_data());
                        break;
                    }
                    case kStructData: {
                        _internal_mutable_struct_data()->PROTOBUF_NAMESPACE_ID::Struct::MergeFrom(
                                from._internal_struct_data());
                        break;
                    }
                    case kValueData: {
                        _internal_mutable_value_data()->PROTOBUF_NAMESPACE_ID::Value::MergeFrom(
                                from._internal_value_data());
                        break;
                    }
                    case kListValueData: {
                        _internal_mutable_list_value_data()->PROTOBUF_NAMESPACE_ID::ListValue::MergeFrom(
                                from._internal_list_value_data());
                        break;
                    }
                    case kTsData: {
                        _internal_mutable_ts_data()->PROTOBUF_NAMESPACE_ID::Timestamp::MergeFrom(
...
// @@protoc_insertion_point(one_of_clear_start:proto_util_converter.testing.oneofs.OneOfsRequest)
                switch (data_case()) {
                    case kStrData: {
                        data_.str_data_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                                GetArenaForAllocation());
                        break;
                    }
                    case kIntData: {
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.oneofs.OneOfsRequest)
            ...
            const char *
            OneOfsRequest::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
...
// ===================================================================
            ...
            public:
                static const ::proto_util_converter::testing::oneofs::Data &
                message_data(const RequestWithSimpleOneof *msg);

                static const ::proto_util_converter::testing::oneofs::MoreData &
                more_data(const RequestWithSimpleOneof *msg);
            };
            ...
            void RequestWithSimpleOneof::set_allocated_message_data(
            ...
            void RequestWithSimpleOneof::set_allocated_more_data(
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.oneofs.RequestWithSimpleOneof)
            ...
            const char *RequestWithSimpleOneof::_InternalParse(const char *ptr,
...
// ===================================================================
            ...
            MoreData::MoreData(const MoreData &from)
                ...
                if (!from._internal_str_value().empty()) {
                    str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
                                   from._internal_str_value(),
                                   GetArenaForAllocation());
                }
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.oneofs.MoreData)
            ...
            const char *
            MoreData::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
                while (!ctx->Done(&ptr)) {
                    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
                    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.oneofs.Response)
            ...
            const char *
            Response::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
                while (!ctx->Done(&ptr)) {
                    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
                    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
PROTOBUF_NAMESPACE_OPEN
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::oneofs::OneOfsRequest *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::oneofs::RequestWithSimpleOneof *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::oneofs::Data *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::oneofs::MoreData *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::oneofs::Response *
