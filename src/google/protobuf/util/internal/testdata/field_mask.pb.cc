...
namespace proto_util_converter {
    namespace testing {
        constexpr NestedFieldMask::NestedFieldMask(
                ...
                : repeated_mask_(), data_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string),
        ...
        constexpr FieldMaskTest::FieldMaskTest(
                ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
                : repeated_mask_(), nested_mask_(), id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string),
                  single_mask_(nullptr) {}
        ...
        constexpr FieldMaskTestCases::FieldMaskTestCases(
                ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
                : single_mask_(nullptr), multiple_mask_(nullptr), snake_camel_(nullptr), empty_field_(nullptr),
                  apiary_format1_(nullptr), apiary_format2_(nullptr), apiary_format3_(nullptr), map_key1_(nullptr),
                  map_key2_(nullptr), map_key3_(nullptr), map_key4_(nullptr), map_key5_(nullptr) {}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto = {
        ...
        descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto_deps, 1, 4,
        schemas, file_default_instances,
        TableStruct_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto::offsets,
        file_level_metadata_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto,
        file_level_enum_descriptors_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto,
...
descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto_getter() {
    return &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto(
        &descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2ffield_5fmask_2eproto);
namespace proto_util_converter {
    namespace testing {
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.NestedFieldMask)
        ...
        const char *
        NestedFieldMask::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.NestedFieldMask)
            ...
            if (from.has_single_mask()) {
                _internal_mutable_single_mask()->PROTOBUF_NAMESPACE_ID::FieldMask::MergeFrom(
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.FieldMaskTest)
        ...
        const char *
        FieldMaskTest::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
            while (!ctx->Done(&ptr)) {
                ::PROTOBUF_NAMESPACE_ID::uint32 tag;
                ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
// ===================================================================
        ...
        public:
            ...
            static const ::proto_util_converter::testing::FieldMaskWrapper &
            multiple_mask(const FieldMaskTestCases *msg);
            ...
            static const ::proto_util_converter::testing::FieldMaskWrapper &
            apiary_format1(const FieldMaskTestCases *msg);

            static const ::proto_util_converter::testing::FieldMaskWrapper &
            apiary_format2(const FieldMaskTestCases *msg);

            static const ::proto_util_converter::testing::FieldMaskWrapper &
            apiary_format3(const FieldMaskTestCases *msg);
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.FieldMaskTestCases)
        ...
        const char *
        FieldMaskTestCases::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
            while (!ctx->Done(&ptr)) {
                ::PROTOBUF_NAMESPACE_ID::uint32 tag;
                ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
// @@protoc_insertion_point(class_specific_merge_from_start:proto_util_converter.testing.FieldMaskTestCases)
            ...
            if (from.has_single_mask()) {
                _internal_mutable_single_mask()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_single_mask());
            }
            if (from.has_multiple_mask()) {
                _internal_mutable_multiple_mask()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_multiple_mask());
            }
            if (from.has_snake_camel()) {
                _internal_mutable_snake_camel()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_snake_camel());
            }
            if (from.has_empty_field()) {
                _internal_mutable_empty_field()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_empty_field());
            }
            if (from.has_apiary_format1()) {
                _internal_mutable_apiary_format1()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_apiary_format1());
            }
            if (from.has_apiary_format2()) {
                _internal_mutable_apiary_format2()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_apiary_format2());
            }
            if (from.has_apiary_format3()) {
                _internal_mutable_apiary_format3()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_apiary_format3());
            }
            if (from.has_map_key1()) {
                _internal_mutable_map_key1()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_map_key1());
            }
            if (from.has_map_key2()) {
                _internal_mutable_map_key2()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_map_key2());
            }
            if (from.has_map_key3()) {
                _internal_mutable_map_key3()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_map_key3());
            }
            if (from.has_map_key4()) {
                _internal_mutable_map_key4()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
                        from._internal_map_key4());
            }
            if (from.has_map_key5()) {
                _internal_mutable_map_key5()->::proto_util_converter::testing::FieldMaskWrapper::MergeFrom(
...
// @@protoc_insertion_point(message_clear_start:proto_util_converter.testing.FieldMaskWrapper)
        ...
        const char *
        FieldMaskWrapper::_InternalParse(const char *ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext *ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
            while (!ctx->Done(&ptr)) {
                ::PROTOBUF_NAMESPACE_ID::uint32 tag;
                ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
PROTOBUF_NAMESPACE_OPEN
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::NestedFieldMask *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::FieldMaskTest *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::FieldMaskTestCases *
        ...
        template<>
        PROTOBUF_NOINLINE ::proto_util_converter::testing::FieldMaskWrapper *
